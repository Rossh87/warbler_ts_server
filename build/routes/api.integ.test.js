...
describe('api route handlers', function () {
    it('responds with json of user object', function () { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest_1.default(app).get('/api/user')];
                case 1:
                    response = _a.sent();
    ...
    it('responds to GET /messages with JSON of all messages', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/];
        });
    }); });
